...
mataGaruda.controller('DashboardCtrl', ['$scope','$http', function($scope, $http){
	...
	$scope.topAttackerConfig = exampleConfig;
	$scope.topEventConfig = {
        chart: {
            type: 'bar'
        },
        title: {
...
mataGaruda.directive('leftmenu', [function(){
	// Runs during compile
	return {
		name: 'leftmenu',
		// priority: 1,
...
mataGaruda.directive('topmenu', [function(){
	// Runs during compile
	return {
		name: 'topmenu',
		// priority: 1,
		...
		restrict: 'E', // E = Element, A = Attribute, C = Class, M = Comment
		// template: '',
		templateUrl: 'views/menu/topmenu.html',
		replace: true,
		// transclude: true,
		// compile: function(tElement, tAttrs, function transclude(function(scope, cloneLinkingFn){ return function linking(scope, elm, attrs){}})),
		link: function($scope, iElm, iAttrs, controller) {
